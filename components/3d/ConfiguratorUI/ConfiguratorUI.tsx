...
const ConfiguratorUI = ({
  ...
  const isTransparentBackboard =
    backboardColor === 'transparent' || backboardColor === 'Transparent';

  return (
    <div
      id="gjcz"
      className="gjcz w-full text-gray-900"
      style={{
        fontFamily:
    ...
    >
      ...
      >
        ...
        >
          <svg width="14" height="14" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path
              fillRule="evenodd"
              d="M10 7.25c-.69 0-1.25.56-1.25 1.25a.75.75 0 0 1-1.5 0 2.75 2.75 0 1 1 3.758 2.56.61.61 0 0 0-.226.147.154.154 0 0 0-.032.046.75.75 0 0 1-1.5-.003c0-.865.696-1.385 1.208-1.586A1.25 1.25 0 0 0 10 7.25Z"
            />
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: isActive ? 'inset 0 0 0 2px #0e0f11' : 'inset 0 0 0 1px #e6e7e9',
      ...
      <div className="gjcz__row">
        <div className="gjcz__lab">
          <span className="gjcz__labtxt">
            NAME & NUMBER <span className="gjcz__req">*</span>
          </span>
        </div>
        <div className="gj-nn">
          <div className="gj-name">
            <input
              type="text"
              value={name}
              onChange={(e) => setName(e.target.value.slice(0, 13).toUpperCase())}
              maxLength={13}
              placeholder="NAME"
              autoComplete="off"
            />
            <div className="gj-cnt">
              {nameLen}/13 characters
            </div>
          </div>
          <div className="gj-num">
            <input
              type="text"
              value={number}
      ...
      <div className="gjcz__row">
        <div className="gjcz__lab">
          <span className="gjcz__labtxt">
            JERSEY COLOR <span className="gjcz__req">*</span>
          </span>
          <em className="gj-selname">
            {jerseyColors.find((c) => c.hex.toLowerCase() === outlineColor?.toLowerCase())
              ?.name || ''}
          </em>
        </div>
        <div className="gj-sw">
      ...
      <div className="gjcz__row">
        <div className="gjcz__lab">
          <span className="gjcz__labtxt">
            NAME COLOR <span className="gjcz__req">*</span>
          </span>
          <em className="gj-selname">
            {jerseyColors.find((c) => c.hex.toLowerCase() === nameColor?.toLowerCase())
              ?.name || ''}
          </em>
        </div>
        <div className="gj-sw">
      ...
      <div className="gjcz__row">
        <div className="gjcz__lab">
          <span className="gjcz__labtxt">
            NUMBER COLOR <span className="gjcz__req">*</span>
          </span>
          <em className="gj-selname">
            {jerseyColors.find((c) => c.hex.toLowerCase() === numberColor?.toLowerCase())
              ?.name || ''}
          </em>
        </div>
        <div className="gj-sw">
      ...
      <div className="gjcz__row">
        <div className="gjcz__lab">
          <span className="gjcz__labtxt">
            BACKBOARD <span className="gjcz__req">*</span>
          </span>
          <em className="gj-selname">
      ...
      <div className="mt-6">
        <div className="product__accordion accordion border-t border-b border-gray-200">
          ...
          >
            <span className="summary__title flex flex-1 items-center">
              <svg
                ...
                height="20"
                viewBox="0 0 20 20"
                style={{ flexShrink: 0, marginRight: '1.2rem' }}
              >
                <path
              ...
              <span
                className="accordion__title uppercase"
            ...
            <svg
              ...
              aria-hidden="true"
              focusable="false"
              className={`icon icon-caret w-[12px] h-[8px] transition-transform duration-300 ${
                openAcc === 'sizes' ? 'scale-y-[-1]' : ''
              }`}
              fill="none"
              viewBox="0 0 24 15"
            >
          ...
          >
            <div
              className="pb-6 text-[14px] text-gray-600 leading-relaxed overflow-y-auto"
      ...
      >
        <svg
          className="icon icon-accordion flex-shrink-0"
          aria-hidden="true"
          focusable="false"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
        ...
        CUSTOM GLOW JERSEYS ARE NOT REFUNDABLE, RETURNABLE, OR REPLACEABLE. PLEASE MAKE SURE ALL
        DETAILS ARE CORRECT.
      </p>
    </div>
  );
